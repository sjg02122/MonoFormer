...
from monoformer.trainers.base_trainer import BaseTrainer, sample_to_cuda
from monoformer.utils.config import prep_logger_and_checkpoint
from monoformer.utils.logging import print_config
from monoformer.utils.logging import AvgMeter
...
class HorovodTrainer(BaseTrainer):
    ...
    def train(self, dataloader, module, optimizer):
        ...
        for i, batch in progress_bar:
            ...
            if self.is_rank_0:
                ...
                #wandb.log({"avg_loss_step":self.avg_loss(output['loss'].item())})
    ...
    def validate(self, dataloaders, module):
        ...
        for n, dataloader in enumerate(dataloaders):
            ...
            #wandb.log({"validate_all_output ":all_outputs})
    ...
    def evaluate(self, dataloaders, module):
        ...
        for n, dataloader in enumerate(dataloaders):
            ...
            # Append dataset outputs to list of all outputs
            all_outputs.append(outputs)
            #wandb.log({"eval output":all_outputs})
