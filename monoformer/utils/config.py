...
from monoformer.utils.logging import s3_url, prepare_dataset_prefix
from monoformer.utils.horovod import on_rank_0
from monoformer.utils.types import is_cfg, is_list
from monoformer.utils.misc import make_list
from monoformer.utils.load import load_class, backwards_state_dict
...
def parse_test_config(ckpt_file, cfg_default, cfg_file):
    ...
    if ckpt_file.endswith('.ckpt'):
        ...
        # config = merge_cfgs(config_default, cfg_file)
        config = merge_cfg_file(config_default, cfg_file)
