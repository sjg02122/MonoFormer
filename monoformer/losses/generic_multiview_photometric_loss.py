...
from monoformer.geometry.camera_generic import GenericCamera
from monoformer.geometry.camera_utils import view_synthesis_generic
...
########################################################################################################################
    ...
    def warp_ref_image(self, inv_depths, ref_image, raysurf_residual, pose, progress):
        ...
        wandb.Image(ref_images,caption="Ref_Images")
        ...
        wandb.Image(ref_warped,caption='Ref_warped_Images')
        return ref_warped
