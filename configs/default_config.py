...
########################################################################################################################
cfg.arch = CN()
cfg.arch.seed = 4969                     # Random seed for Pytorch/Numpy initialization
...
cfg.checkpoint.save_top_k = 8           # Number of best models to save
cfg.checkpoint.monitor = 'loss'         # Metric to monitor for logging
cfg.checkpoint.monitor_index = 1        # Dataset index for the metric to monitor
...
cfg.checkpoint.s3_frequency = 0         # How often to s3 sync
########################################################################################################################
### SAVE
########################################################################################################################
cfg.save = CN()
...
cfg.model.loss.upsample_depth_maps = False       # Resize depth maps to highest resolution
#
...
cfg.model.loss.clip_loss = 0.5                  # Clip loss threshold variance
...
cfg.model.depth_net.backbone =''
cfg.model.depth_net.features=256
...
cfg.datasets.train.batch_size = 6                   # Training batch size
cfg.datasets.train.num_workers = 24                 # Training number of workers
...
cfg.datasets.validation.num_workers = 4             # Validation number of workers
...
cfg.datasets.test.num_workers = 4                   # Test number of workers
